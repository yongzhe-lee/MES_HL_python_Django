...
class Line(models.Model):
    ...
    smt_yn = models.CharField('smt라인여부', max_length=1, null=True, db_comment="SMT라인여부")
...
class Material(models.Model):
    ...
    Name = models.CharField('품목명', max_length=100, db_comment="품목명")  # 개별 고유 제약 적용
...
class MonthlyTermResult(models.Model):
    ...
    Line = models.ForeignKey(Line, on_delete=models.DO_NOTHING, db_comment="라인 ID (참조키)", db_column="line_pk", null=True)
...
class SolderViscosityCheckResult(models.Model):
    ...
    LotNo = models.CharField('LotNo', max_length=50, null=True, db_comment="Lot No", db_column="lot_no")
    SerialNo = models.CharField('SerialNo', max_length=50, null=True, db_comment="Lot No", db_column="sn")
    InDate = models.DateField('입고일자', null=True, db_comment="입고일자", db_column="in_date")
    ExpirationDate = models.DateField('만료일자', null=True, db_comment="만료일자", db_column="exp_date")
    RefrigeratorInDate = models.DateTimeField("냉장고입고일자", db_comment="냉장고입고일잘", db_column="refr_in_date", null=True)
    Equipment = models.ForeignKey(Equipment, on_delete=models.DO_NOTHING, db_comment="설비 ID (참조키)", db_column="equip_pk", null=True)    
    ...
    class Meta():
        ...
        verbose_name = '땜납점도체크'
        db_table_comment = '솔더비저코시티체크 관리 테이블'
